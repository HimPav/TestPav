...
Как Опреартор я хочу
создать клиента
чтобы ввести клиента в базу
...
*Заполнение номера телефона клиента
	Когда открылось окно 'Контрагент (создание) *'
	И в поле с именем 'Телефон' я ввожу текст '+79452128507'	
*Сохранение
	Когда открылось окно 'Контрагент (создание) *'
...
*Проверка сохранения по коду
	...
	И я жду закрытия окна 'ООО Ромашка (Контрагент)' в течение 20 секунд
